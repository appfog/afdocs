...
First, add the MongoMapper gem:

{: .prettyprint}
    $ gem install "mongo_mapper"


Also, add BSON for serialization of JSON-like documents, which is necessary for interfacing with the MongoDB Ruby driver.
